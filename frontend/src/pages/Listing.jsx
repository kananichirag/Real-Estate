...
//   const [Copied,setCopied] = useState(false);
  ...
  return (
    <main>
      ...
      {error && (
        <p className="text-center py-7 text-2xl">Something Went Wrong..!!</p>
      )}
      {listing && !loading && !error && (
        <div>
          ...
          {/* <FaShare className='text-salte-500' onClick={ () =>  {
          ...
          <div>
            ...
            <div className="flex flex-col max-w-4xl p-5 mx-auto my-7 gap-4">
              ...
              <p className="flex items-center mt-2 gap-2 text-slate-600 text-sm">
                {/* <FaMapMarkerAlt className='text-green-700'>{listing.address}</FaMapMarkerAlt> */}
              </p>
              ...
              <ul className="text-green-900 font-semibold text-sm flex flex-wrap gap-4 sm:gap-6 items-center">
                ...
                <li className="flex items-center gap-2 whitespace-nowrap ">
                  <FaParking className="text-xl"></FaParking>
                  {listing.parking ? "Parking Spot" : "No Parking"}
                </li>

                <li className="flex items-center gap-2 whitespace-nowrap ">
                  <FaChair className="text-xl"></FaChair>
