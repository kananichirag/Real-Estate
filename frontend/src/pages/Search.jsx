...
export default function () {
    ...
    const [showMore, setshowMore] = useState(false);
     ...
     useEffect( () => {
        ...
        if(
            searchTermFromUrl || typeFromUrl || parkingFromUrl || furnishedFromUrl || offerFromUrl ||
        ...
        <div className='p-7 border-b-2 md:border-r-2  md:min-h-screen'>
            <form onSubmit={handleSubmit} className='flex flex-col gap-8'>
                <div className='flex items-center  gap-2'>
                    ...
                    <input className='border rounded-lg p-3 w-full' type='text' id='searchTerm' placeholder='Search..' value={sidebardata.searchTerm}  onChange={handleChange}></input>
                </div>
